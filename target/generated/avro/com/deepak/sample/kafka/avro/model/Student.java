 ...
 */
package com.deepak.sample.kafka.avro.model;
...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8825917290156796667L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.deepak.sample.kafka.avro.model\",\"fields\":[{\"name\":\"studentName\",\"type\":\"string\"},{\"name\":\"studentId\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"}]}");
   ...
   */
  public static com.deepak.sample.kafka.avro.model.Student.Builder newBuilder() {
    return new com.deepak.sample.kafka.avro.model.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.deepak.sample.kafka.avro.model.Student.Builder newBuilder(com.deepak.sample.kafka.avro.model.Student.Builder other) {
    if (other == null) {
      return new com.deepak.sample.kafka.avro.model.Student.Builder();
    } else {
      return new com.deepak.sample.kafka.avro.model.Student.Builder(other);
    }
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.deepak.sample.kafka.avro.model.Student.Builder newBuilder(com.deepak.sample.kafka.avro.model.Student other) {
    if (other == null) {
      return new com.deepak.sample.kafka.avro.model.Student.Builder();
    } else {
      return new com.deepak.sample.kafka.avro.model.Student.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.deepak.sample.kafka.avro.model.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.deepak.sample.kafka.avro.model.Student other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.studentName)) {
        this.studentName = data().deepCopy(fields()[0].schema(), other.studentName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.deepak.sample.kafka.avro.model.Student.Builder setStudentName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.deepak.sample.kafka.avro.model.Student.Builder clearStudentName() {
      studentName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.deepak.sample.kafka.avro.model.Student.Builder setStudentId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.deepak.sample.kafka.avro.model.Student.Builder clearStudentId() {
      studentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.deepak.sample.kafka.avro.model.Student.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.deepak.sample.kafka.avro.model.Student.Builder clearAge() {
